    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("finance") ?>" href="<?= home_url("app/finance") ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("wordpress") ?>" href="<?= home_url("app/wordpress") ?>">
                        <i class="mdi mdi-wordpress"></i> <span data-key="t-wordpress">Wordpress</span>
                    </a>
                    <a class="nav-link menu-link <?= activeClassName("reactjs") ?>" href="<?= home_url("app/reactjs") ?>">
                        <i class="mdi mdi-react"></i> <span>ReactJS</span>
                    </a>
                    <a class="nav-link menu-link <?= activeClassName("salesforce") ?>" href="<?= home_url("app/salesforce") ?>">
                        <i class="mdi mdi-salesforce"></i> <span>Salesforce</span>
                    </a>
                </li>
                <li class="menu-title"><span data-key="t-app">App</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("bookmark") ?>" href="<?= home_url("app/bookmark") ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("ai-chat") ?>" href="<?= home_url("app/ai-chat") ?>">
                        <i class="ri-chat-3-line"></i> <span data-key="t-ai-chat">AI Chat</span>
                    </a>
                </li>
                <li class="menu-title"><span data-key="t-work">Work</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("projects") ?>" href="<?= home_url("app/projects") ?>">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("website") ?>" href="<?= home_url("app/website") ?>">
                        <i class="ri-links-line"></i> <span data-key="t-website">Website</span>
                    </a>
                </li>
                <li class="menu-title"><span data-key="t-network">English</span></li>
                <li class="nav-item">
                    <a class="nav-link menu-link <?= activeClassName("grammar") ?>" href="<?= home_url("app/grammar") ?>">
