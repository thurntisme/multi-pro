                    ...
                    <div class="row">
                                        ...
                                        <table class="table table-borderless table-nowrap align-middle mb-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td style="width:5%;">
                                                        <div id="radialBar_chart_1" data-colors="" data-chart-series="50" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td>
                                                        <div id="radialBar_chart_2" data-colors="" data-chart-series="45" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td>
                                                        <div id="radialBar_chart_3" data-colors="" data-chart-series="75" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td>
                                                        <div id="radialBar_chart_4" data-colors="" data-chart-series="25" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td>
                                                        <div id="radialBar_chart_5" data-colors="" data-chart-series="60" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td>
                                                        <div id="radialBar_chart_6" data-colors="" data-chart-series="85" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                                <tr>
                                                    <td class="d-flex">
                                                    ...
                                                    <td>
                                                        <div id="radialBar_chart_7" data-colors="" data-chart-series="70" class="apex-charts" dir="ltr"></div>
                                                    </td>
                                                </tr><!-- end tr -->
                                            </tbody><!-- end tbody -->
                                        </table><!-- end table -->
                                                ...
                                                <li class="chat-list left">
                                                    <div class="conversation-list">
                                                        ...
                                                        <div class="user-chat-content">
                                                            ...
                                                            <div class="ctext-wrap">
                                                                <div class="ctext-wrap-content">
                                                                    <p class="mb-0 ctext-content">Hey, I am going to meet a friend of mine at the department store. I have to buy some presents for my parents 🎁.</p>
                                                                </div>
                                                                <div class="dropdown align-self-start message-box-drop">
                                                                    <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                        <i class="ri-more-2-fill"></i>
                                                ...
                                                <li class="chat-list right">
                                                    <div class="conversation-list">
                                                        <div class="user-chat-content">
                                                            <div class="ctext-wrap">
                                                                <div class="ctext-wrap-content">
                                                                    <p class="mb-0 ctext-content">Wow that is great</p>
                                                                </div>
                                                                <div class="dropdown align-self-start message-box-drop">
                                                                    <a class="dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                                        <i class="ri-more-2-fill"></i>
                        ...
                        <div class="col-xxl-4 col-lg-6">
                            <div class="card card-height-100">
                                ...
                                <div class="card-body">
                                    <div id="prjects-status" data-colors="" class="apex-charts" dir="ltr"></div>
                                    <div class="mt-3">
