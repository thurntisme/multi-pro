                        ...
                        <div class="row">
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <input class="form-control" placeholder="Enter event title" type="text" name="title"
                                        id="event-title" required value="<?= $postData['title'] ?? '' ?>" />
                            ...
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group">
                                        <input type="text" id="event-start-date" name="date_range"
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input id="start_time" name="start_time" type="text"
                                                    ...
                                                    value="<?= $postData['start_time'] ?? '' ?>" readonly>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <div class="input-group">
                                                <input id="end_time" name="end_time" type="text"
                                                    ...
                                                    value="<?= $postData['end_time'] ?? '' ?>" readonly>
                                                <span class="input-group-text"><i class="ri-time-line"></i></span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div>
                                        <input type="text" class="form-control" name="location" id="event-location"
                                            placeholder="Event location" value="<?= $postData['location'] ?? '' ?>">
                                    </div>
                                </div>
                            </div>
                            <!--end col-->
                            <div class="col-12">
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control" id="event-description" name="description"
                                        ...
                                        spellcheck="false"><?= $postData['description'] ?? '' ?></textarea>
                                </div>
                            </div>
                            <!--end col-->
                        </div>
