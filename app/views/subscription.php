...
<div class="card" id="tasksList">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="flex-shrink-0">
                <div class="d-flex flex-wrap gap-2">
                    <a class="btn btn-danger add-btn"
                        href="<?= App\Helpers\NetworkHelper::home_url('subscription/new') ?>"><i
    ...
    <div class="card-body border border-dashed border-end-0 border-start-0">
        <form method="get" action="<?= App\Helpers\NetworkHelper::home_url('subscription') ?>">
            <div class="row g-3">
                ...
                <div class="col-xxl-3 col-sm-4">
                    <div class="input-light">
                        <select class="form-control" data-choices data-choices-search-false name="payment_type">
                            <?php
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-baseline">
                                        <a class="text-black"
                                            href="<?= App\Helpers\NetworkHelper::home_url('app/subscription/detail?id=' . $item['id']) ?>"><?= $item['service_name'] ?></a>
                                        <ul class="list-inline tasks-list-menu mb-0 ms-3">
                                            <li class="list-inline-item m-0"><a class="edit-item-btn btn btn-link btn-sm"
                                                    href="<?= App\Helpers\NetworkHelper::home_url('app/subscription/detail?id=' . $item['id']) ?>"><i
                                                        class="ri-eye-fill align-bottom text-muted"></i></a>
                                            </li>
                                            <li class="list-inline-item m-0"><a class="edit-item-btn btn btn-link btn-sm"
                                                    href="<?= App\Helpers\NetworkHelper::home_url('app/subscription/edit?id=' . $item['id']) ?>"><i
                                ...
                                <td class="text-end pe-5">
                                    <?= $commonController->getCurrencySymbol($item['currency']) . ' ' . $item['amount'] ?>
                                </td>
                                <td class="text-center text-capitalize"><?= $item['payment_type'] ?></td>
                                <td class="text-center"><?= $item['payment_date'] ?></td>
                                <td class="text-center">
                                    <?= $item['payment_type'] === 'yearly' ? $months[$item['payment_month']] : '' ?></td>
