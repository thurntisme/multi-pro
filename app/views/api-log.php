...
<div class="card" id="tasksList">
    ...
    <div class="card-body border border-dashed border-end-0 border-start-0">
        <form method="get" action="<?= App\Helpers\NetworkHelper::home_url('app/api-log') ?>">
            <div class="row g-3">
                ...
                <div class="col-xxl-2 col-sm-4 d-flex">
                    ...
                    <a href="<?= App\Helpers\NetworkHelper::home_url("app/api-log") ?>" class="btn btn-danger ms-1"><i
