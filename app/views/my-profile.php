              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <p>Hi I'm Anna Adame, It will be as simple as Occidental; in fact, it will be Occidental. To an
                    ...
                    me what Occidental is European languages are members of the same family.</p>
                  <p>You always want to make sure that your fonts work well together and try to limit the number of
                    fonts you use to three or less. Experiment and play around with the fonts that you already have in
                    the software you’re working with reputable font websites. This may be the most commonly encountered
                    tip I received from the designers I spoke with. They highly encourage that you use different fonts
                    in one design, but do not over-exaggerate and go overboard.</p>
                  <div class="row">
                            ...
                            <div class="accordion accordion-flush" id="todayExample">
                              <div class="accordion-item border-0">
                                ...
                                <div id="collapseOne" class="accordion-collapse collapse show"
                                  ...
                                  <div class="accordion-body ms-2 ps-5">
                                    In an awareness campaign, it is vital for people to begin put 2 and 2 together and
                                    begin to recognize your cause. Too much or too little spacing, as in the example
                                    below, can make things unpleasant for the reader. The goal is to make your text as
                                    comfortable to read as possible. A wonderful serenity has taken possession of my
                                    ...
                                    <div class="row g-2">
                                      <div class="col-auto">
                                        <div class="d-flex border border-dashed p-2 rounded position-relative">
                                          ...
                                          <div class="flex-grow-1 ms-2">
                                            <h6>
                                              <a href="javascript:void(0);" class="stretched-link">Business Template -
                                                UI/UX design</a>
                                            </h6>
                                            <small>685 KB</small>
                                          </div>
                                      ...
                                      <div class="col-auto">
                                        <div class="d-flex border border-dashed p-2 rounded position-relative">
                                          ...
                                          <div class="flex-grow-1 ms-2">
                                            <h6 class="mb-0">
                                              <a href="javascript:void(0);" class="stretched-link">Bank Management
                                                System - PSD</a>
                                            </h6>
                                            <small>8.78 MB</small>
                                          </div>
                                  ...
                                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex">
                                      ...
                                      <div class="flex-grow-1 ms-3">
                                        ...
                                        <small class="text-muted mb-2">User <span class="text-secondary">Erica245</span>
                              ...
                              <div class="accordion-item border-0">
                                ...
                                <div id="collapseFive" class="accordion-collapse collapse show"
                                  ...
                                  <div class="accordion-body ms-2 ps-5">
                                    <p class="text-muted mb-2"> Every team project can have a velzon. Use the velzon to
                                  ...
                                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex">
                                      ...
                                      <div class="flex-grow-1 ms-3">
                                        ...
                                        <small class="text-muted">We talked about a project on linkedin - 1 week
                                          Ago</small>
                                      </div>
                                    </div>
                                  </a>
                                  ...
                                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex">
                                      ...
                                      <div class="flex-grow-1 ms-3">
                                        ...
                                        <small class="text-muted mb-2">User <span class="text-secondary">Jack365</span>
                                  ...
                                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex">
                                      ...
                                      <div class="flex-grow-1 ms-3">
                                        ...
                                        <small class="text-muted">Adding a new event with attachments - 1 month
                                          Ago.</small>
                                      </div>
                                    </div>
                                  </a>
                                  ...
                                  <a class="accordion-button p-2 shadow-none" data-bs-toggle="collapse"
                                    ...
                                    <div class="d-flex">
                                      ...
                                      <div class="flex-grow-1 ms-3">
                                        ...
                                        <small class="text-muted">Create new project buildng product - 8 month
                                          Ago</small>
                                      </div>
                                    </div>
                                  </a>
