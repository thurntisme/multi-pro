...
if (!empty($modify_type)) {
    ...
    if ($modify_type === "new") {
        ...
        if (isset($_GET['id'])) {
            $post_id = $_GET['id'];
            $postData = $tipController->viewTip($post_id);
        }
...
ob_start();
?>
<form method="POST" action="<?= $_SERVER['REQUEST_URI'] ?>" id="tip">
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="mb-3">
                        <label class="form-label" for="tip-title-input">Title</label>
                        <input type="text" class="form-control" id="tip-title-input" name="title"
                            placeholder="Enter title" value="<?= $postData['title'] ?? '' ?>">
                        <?php if (!empty($post_id)) { ?>
                            <input type="hidden" name="tip_id" value="<?= $post_id ?>">
                        <?php } ?>
                    </div>
                    ...
                    <div class="mb-3">
                        <label class="form-label" for="tip-url-input">Url</label>
                        <input type="text" class="form-control" id="tip-url-input" name="url" placeholder="Enter url"
                            value="<?= $postData['url'] ?? '' ?>">
                    </div>
            ...
            <div class="text-center mb-4">
                <a href="<?= App\Helpers\NetworkHelper::home_url('tip') ?>" class="btn btn-light w-sm">Back</a>
                <button type="submit"
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<?= App\Helpers\NetworkHelper::home_url('tip') ?>" class="btn btn-light w-sm">Back</a>
                    <a href="<?= App\Helpers\NetworkHelper::home_url('tip/detail?id=' . $postData['id']) ?>"
