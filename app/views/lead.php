...
<div class="row">
                    ...
                    <div class="flex-shrink-0">
                        <div class="hstack text-nowrap gap-2">
                            ...
                            <button type="button" id="dropdownMenuLink1" data-bs-toggle="dropdown" aria-expanded="false"
                                class="btn btn-soft-info"><i class="ri-more-2-fill"></i>
                            </button>
    ...
    <div class="col-lg-12">
        <div class="card" id="companyList">
            <div class="card-header">
                <form method="get" action="<?= App\Helpers\NetworkHelper::home_url('lead') ?>">
                    <div class="row g-2">
                        <div class="col-md-3">
                        ...
                        <div class="col-md-3 ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <div class="flex-grow-1">
                                    <select class="form-control mb-0" data-choices data-choices-search-false name="tag"
                        ...
                        <a class="btn btn-soft-success w-auto ms-2"
                            href="<?= App\Helpers\NetworkHelper::home_url("lead") ?>"><i
                                                            ...
                                                            <?php foreach ($item['social_links'] as $slug => $link):
                                                                if (!empty($link)): ?>
                                                                    <li class="list-inline-item"><a target="_blank"
                                                                            rel="noopener noreferrer" href="<?= $link ?>"><i
