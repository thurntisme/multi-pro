...
<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="<?= App\Helpers\NetworkHelper::home_url('app/') ?>" class="logo logo-dark">
            <span class="logo-sm">
                <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/logo-sm.png") ?>" alt="" width="32"
                    height="32">
            </span>
            <span class="logo-lg">
                <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/dark-logo.png") ?>" alt="" height="29">
            </span>
        </a>
        <!-- Light Logo-->
        <a href="<?= App\Helpers\NetworkHelper::home_url('app/') ?>" class="logo logo-light">
            ...
            <span class="logo-lg">
                <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/light-logo.png") ?>" alt=""
                    height="29">
            </span>
        </a>
