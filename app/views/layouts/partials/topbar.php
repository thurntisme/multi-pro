            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box horizontal-logo">
                    <a href="index" class="logo logo-dark">
                        <span class="logo-sm">
                            <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/logo-sm.png") ?>" alt=""
                                height="22">
                        </span>
                        <span class="logo-lg">
                            <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/logo-dark.png") ?>" alt=""
                                height="17">
                        </span>
                    </a>
                    ...
                    <a href="index" class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/logo-light.png") ?>" alt=""
                                height="17">
                        </span>
                    </a>
                </div>
                ...
                <form class="app-search d-none d-md-block" method="get"
                    action="<?= App\Helpers\NetworkHelper::home_url('app/search') ?>">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="dropdown ms-1 topbar-head-dropdown header-item">
                    <button type="button" class="btn btn-icon btn-topbar btn-ghost-secondary rounded-circle"
                        ...
                        <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/flags/" . $cur_lang . ".svg") ?>"
                        ...
                        <div data-simplebar style="max-height: 300px;">
                            <div class="p-2">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/products/img-1.png") ?>"
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/products/img-2.png") ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/products/img-3.png") ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/products/img-6.png") ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                                ...
                                <div class="d-block dropdown-item dropdown-item-cart text-wrap px-3 py-2">
                                    <div class="d-flex align-items-center">
                                        <img src="<?= App\Helpers\NetworkHelper::home_url("assets/images/products/img-5.png") ?>"
                                            class="me-3 rounded-circle avatar-sm p-2 bg-light" alt="user-pic">
                                        <div class="flex-grow-1">
                                            <h6 class="mt-0 mb-1 fs-14">
                ...
                <div class="ms-1 header-item d-none d-sm-flex">
                    <a href="<?= App\Helpers\NetworkHelper::home_url('app/system-notification') ?>"
                        ...
                        <?php if ($systemNotiCount > 0) { ?>
                            <span
                                class="position-absolute topbar-badge fs-10 translate-middle badge rounded-pill bg-danger"><?= $systemNotiCount ?><span
                    ...
                    <button type="button" class="btn" id="page-header-user-dropdown" data-bs-toggle="dropdown"
                        ...
                        <span class="d-flex align-items-center">
                            ...
                            <span class="text-start ms-xl-2">
                                <span
                                    class="d-none d-xl-inline-block ms-1 fw-medium user-name-text"><?= $fullName ?></span>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="mt-2 text-center">
                    <lord-icon
                        src="<?= App\Helpers\NetworkHelper::home_url("https://cdn.lordicon.com/gsqxdxog.json") ?>"
