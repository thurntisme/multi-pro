                            ...
                            <div class="col-md-6">
                                <div>
                                    <label for="player_weight" class="form-label">Weight (kg)<span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="player_weight" id="player_weight"
                                        min="60" max="110" placeholder="Weight (kg)" required />
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div>
                                    <label for="player_height" class="form-label">Height (cm)<span
                                            class="text-danger">*</span></label>
                                    <input type="number" class="form-control" name="player_height" id="player_height"
                                        min="165" max="200" placeholder="Height (cm)" required />
                                </div>
                            </div>
                        </div>
                    </div>
