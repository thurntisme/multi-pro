                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <select class="form-select" name="currency" id="currency" data-choices
                                    data-choices-search-false data-choices-sorting-false>
                                    <?php
                                    foreach (DEFAULT_CURRENCY as $key => $value) { ?>
                                        <option value="<?= $key ?>" <?= empty($postData['currency']) ? ($key === 'VND' ? 'selected' : '') : (!empty($postData['currency']) && $key === $postData['currency'] ? 'selected' : '') ?>>
                                            <?= $key . ' (' . $value . ')' ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="input-group">
                                    <input type="number" class="form-control" aria-label="Amount " name="amount"
                                        value="<?= $postData['amount'] ?? '' ?>" min="1" required>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <div class="mb-3">
                                ...
                                <input type="number" id="payment_date" class="form-control" name="payment_date" min="1"
                                    max="31" value="<?= $postData['payment_date'] ?? date("j") ?>"
