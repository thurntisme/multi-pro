                    ...
                    <div class="col-8">
                        <div class="card">
                            <div class="card-header align-items-center justify-content-center d-flex">
                                ...
                                <span class="text-muted fs-12 w-25" id="team-2-name"><?= $match['away_team'] ?></span>
                            </div>
                        ...
                        <div class="card card-height-100">
                            <div class="card-header align-items-center d-flex gap-1">
                                <h4 class="card-title mb-0 fs-14 me-auto" id="curr-time">
                                    <span id="minute" class="d-inline-block text-center" style="width: 20px">00</span>:<span
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex align-items-center justify-content-center h-100">
                                                    <h1 class="mb-0 d-flex align-items-baseline">
                                                        <span>0</span><small class="fs-14 px-2">:</small><span>0</span>
                                                    </h1>
                                                </div>
                                            </div>
                                            <div class="col-5">
                                            ...
                                            <?php foreach ([1, 2, 3] as $idx) { ?>
                                                <div class="col-4">
                                                    <div class="text-center">
                                                        ...
                                                        <div>
                                                            <button type="button" class="btn btn-success rounded-pill w-sm"
...
<div class="modal modal-xl fade" id="matchInfoBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
    role="dialog" aria-labelledby="playerDetailBackdropLabel" aria-hidden="true">
