            ...
            <form method="POST" action="<?= $_SERVER['REQUEST_URI'] ?>">
                ...
                <div class="card-body">
                    <div class="row g-4">
                        ...
                        <div class="col-lg-12">
                            <div>
                                <label for="title-Input" class="form-label">Title <span
                        ...
                        <div class="col-lg-12">
                            <div>
                                ...
                                <input type="text" class="form-control" id="date-expense-Input"
                                    ...
                                    name="date_expense" value="<?= date('Y-m-d') ?>" required />
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div>
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                ...
                                <h2 class="mt-3 ff-secondary fw-semibold fs-22">
                                    <?= convertAmount($monthlyExpenses['expense']); ?>
                                    vnd
                                </h2>
                                <?php if (!empty($monthlyExpenses['lastExpense']) && $monthlyExpenses['lastExpense'] > 0) { ?>
                                    <span class="text-muted fs-12">/ <?= convertAmount($monthlyExpenses['lastExpense']); ?>
                                        vnd</span>
                                <?php } ?>
                    ...
                    <div class="row g-3">
                        <div class="col-xxl-3 col-sm-12">
                            <div class="search-box">
                                <input type="text" name="s" class="form-control search bg-light border-light"
                                    placeholder="Search for expenses or something..." value="<?= $_GET['s'] ?? '' ?>">
                        ...
                        <div class="col-xxl-3 col-sm-4">
                            <div class="input-light">
                                <select class="form-control" data-choices name="category">
                                ...
                                foreach ($list['list'] as $item) {
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <?= $category ? (array_values($category)[0]['icon'] . ' ' . array_values($category)[0]['title']) : '' ?>
                                        </td>
                                        <td class="text-center"><?= convertAmount($item['amount']) ?></td>
                                        <td class="text-center"><?= $systemController->convertDate($item['date_expense']) ?>
                                        </td>
                                        <td class="text-center">
                                            <form method="POST" action="<?= $_SERVER['REQUEST_URI'] ?>">
