    ...
    <div class="row">
        <div class="col-lg-8">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="git-url-input" name="url" placeholder="Enter url"
                            value="<?= $postData['url'] ?? '' ?>">
                    </div>
                </div>
                <!-- end card body -->
            ...
            <div class="text-center mb-4">
                <a href="<?= App\Helpers\NetworkHelper::home_url('git') ?>" class="btn btn-light w-sm">Back</a>
                <button type="submit"
        ...
        <div class="col-lg-4">
            <div class="card">
                ...
                <div class="card-body">
                    <a href="<?= App\Helpers\NetworkHelper::home_url('git') ?>" class="btn btn-light w-sm">Back</a>
                    <a href="<?= App\Helpers\NetworkHelper::home_url('git/detail?id=' . $postData['id']) ?>"
