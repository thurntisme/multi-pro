        ...
        <BCard no-body>
          <BCardBody class="p-0">
            <BAlert variant="warning" class="border-0 rounded-top rounded-0 m-0 d-flex align-items-center" show>
              ...
              <div class="flex-shrink-0">
                <Link to="/pages/profile" class="text-reset text-decoration-underline"><b>Upgrade</b>
                </Link>
              </div>
            </BAlert>
            ...
            <BRow class="align-items-end">
              <BCol sm="8">
                <div class="p-3">
                  ...
                  <div class="mt-3">
                    <Link to="/pages/profile" class="btn btn-success">Upgrade Account!</Link>
                  </div>
                </div>
              </BCol>
              <BCol sm="4">
            ...
            <BRow class="align-items-end">
              <BCol sm="8">
                <div class="p-3">
                  ...
                  <div class="mt-3">
                    <Link to="/pages/profile" class="btn btn-info">Upgrade Account!</Link>
                  </div>
                </div>
              </BCol>
              <BCol sm="4">
        ...
        <BCard no-body>
          <BCardBody class="p-0">
            <BAlert variant="warning" class="border-0 rounded-top rounded-0 m-0 d-flex align-items-center" show>
              ...
              <div class="flex-shrink-0">
                <Link to="/pages/profile" class="text-reset text-decoration-underline"><b>Get Free Gift</b>
                </Link>
              </div>
            </BAlert>
            <div class="d-flex p-3">
              ...
              <div>
                ...
                <div class="mt-3">
                  <Link to="/pages/profile" class="btn btn-secondary">Get a Free Gift</Link>
                </div>
              </div>
            </div>
          </BCardBody>
                ...
                <simplebar data-simplebar style="max-height: 364px;" class="p-3">
                  <div class="acitivity-timeline acitivity-main">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        ...
                        <div class="d-inline-flex gap-2 border border-dashed p-2 mb-2 w-75">
                          <Link to="/ecommerce/product-details" class="bg-light rounded p-1">
                    ...
                    <div class="acitivity-item py-3 d-flex">
                      ...
                      <div class="flex-grow-1 ms-3">
                        <h6 class="mb-1">Today offers by <Link to="/ecommerce/seller-details" class="link-secondary">
        ...
        <BCard no-body class="card-height-100">
          ...
          <BCardHeader class="p-0">
            <BAlert variant="warning" :model-value="true" class="alert-label-icon border-0 rounded-0 m-0 d-flex align-items-center" show>
              ...
              <div class="flex-shrink-0">
                <Link to="/pages/pricing" class="text-reset text-decoration-underline"><b>Upgrade</b></Link>
              </div>
            </BAlert>
          </BCardHeader>
