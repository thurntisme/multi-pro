(function () {
        ...
        if (document.getElementById("header-lang-img")) {
            if (lang == "en") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/us.svg";
            } else if (lang == "sp") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/spain.svg";
            } else if (lang == "gr") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/germany.svg";
            } else if (lang == "it") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/italy.svg";
            } else if (lang == "ru") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/russia.svg";
            } else if (lang == "ch") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/china.svg";
            } else if (lang == "fr") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/french.svg";
            } else if (lang == "ar") {
                document.getElementById("header-lang-img").src =
                    home_url + "/assets/images/flags/ae.svg";
            }
    ...
    function getLanguage() {
        ...
        request.open("GET", home_url + "/assets/lang/" + language + ".json");
    ...
    function initCkeditorClassic() {
        ...
        var ckAdvancedEditor = $(".ckeditor-advanced");
        if (typeof CKEDITOR != "undefined" && ckAdvancedEditor.length) {
            const {
                ClassicEditor,
                Essentials,
                Bold,
            ...
            ckAdvancedEditor.each(function () {
                ClassicEditor.create(this, {
                    plugins: [
                        Essentials,
                        Bold,
                    ...
                    link: {
                        ...
                        decorators: [
                            {
                                mode: "manual", // Allows manual addition of a target attribute
                                label: "Open in a new tab",
                                attributes: {
                                    target: "_blank",  // Target for the link (new tab)
                    ...
                    image: {
                        ...
                        uploadAdapter: {
                            upload: function () {
                                return new Promise(() => {
                                }); // No-op: do nothing for uploads
                            }
                        },
                        uploadUrl: home_url + '/assets/uploads/'
                    },
                    list: {
                        properties: {
                            numbered: true,
