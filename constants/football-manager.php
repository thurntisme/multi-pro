...
const DEFAULT_STORE_ITEMS = [
    ...
    [
        'id' => 8,
        'name' => 'Elite Young Talent Player',
        'slug' => 'elite-young-talent',
        'price' => 2000000,
        'description' => 'Discover an exceptional young talent with outstanding potential and skills to dominate the game.',
        'type' => 'player',
        'image' => 'images/elite-young-talent-player.jpg',
    ],
    [
        'id' => 9,
        'name' => 'Reliable Goalkeeper',
        'slug' => 'reliable-goalkeeper-pack',
        'price' => 4500000,
