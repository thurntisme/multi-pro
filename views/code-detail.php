                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <a href="<?= home_url('code') ?>" class="btn btn-light w-sm">Back</a>
                                <a href="<?= home_url('code/edit?id=' . $postData['id']) ?>"
                                ...
                                <div class="flex-grow-1 ms-3">
                                    ...
                                    <div class="avatar-group mb-2">
                                        <a href="javascript: void(0);" class="avatar-group-item"
                                            data-bs-toggle="toolcode" data-bs-placement="top" title=""
