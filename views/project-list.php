                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                                ...
                                                <div class="d-flex gap-1 align-items-center">
                                                    ...
                                                    <div class="dropdown">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-end">
                                                            <a class="dropdown-item" href="' . home_url("projects/detail?post_id") . '"><i class="ri-eye-fill align-bottom me-2 text-muted"></i> View</a>
                                                            <a class="dropdown-item" href="' . home_url("projects/edit?post_id=") . '"><i class="ri-pencil-fill align-bottom me-2 text-muted"></i> Edit</a>
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="' . home_url("projects/detail?post_id=") . '" class="text-body">Slack brand logo design</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="' . home_url("projects/detail?post_id=") . '" class="text-body">Redesign - Landing page</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="' . home_url("projects/detail?post_id=") . '" class="text-body">Chat Application</a></h5>
                                ...
                                <div class="card-body">
                                    <div class="d-flex flex-column h-100">
                                        ...
                                        <div class="d-flex mb-2">
                                            ...
                                            <div class="flex-grow-1">
                                                <h5 class="mb-1 fs-15"><a href="' . home_url("projects/detail?post_id=") . '" class="text-body">Project App</a></h5>
