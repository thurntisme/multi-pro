...
<script type="text/javascript">
    $(document).ready(function() {
        // Handle active class on .plan-nav links
        $(".plan-nav .nav-item .nav-link").each(function() {
            var $this = $(this);
            if ($this.hasClass("active")) {
                $(".month").each(function(index) {
                    $(".annual").eq(index).hide();
                    $(this).show();
                });
            }
        });

        // Handle click on #month-tab
        ...
        // Handle click on #annual-tab
        $("#annual-tab").on("click", function() {
            $(".month").each(function(index) {
                $(".annual").eq(index).show();
                $(this).hide();
            });
        });
    });
