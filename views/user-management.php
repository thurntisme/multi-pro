...
?>
    ...
    <div class="card" id="tasksList">
        ...
        <div class="card-body border border-dashed border-end-0 border-start-0">
            <form method="get" action="<?= home_url('app/user-management-management') ?>">
                <div class="row g-3">
                    ...
                    <div class="col-xxl-2 col-sm-4 d-flex">
                        ...
                        <a href="<?= home_url("app/user-management-management") ?>" class="btn btn-danger ms-1"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-baseline">
                                        <a class="text-black"
                                           href="<?= home_url('app/user-management/detail?id=' . $item['id']) ?>"><?= $item['username'] ?></a>
