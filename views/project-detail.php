...
if (!empty($projectData)) {
    echo '<div class="page-content pt-4">
                                    ...
                                    <div class="row mb-3">
                                        <div class="col-md">
                                            <div class="row align-items-center g-3">
                                                ...
                                                <div class="col-md">
                                                    <div>
                                                        <h4 class="fw-bold">' . $projectData['title'] . '</h4>
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <div class="col-lg-3 col-sm-6">
                                                                <div>
                                                                    ...
                                                                    <div class="badge bg-' . getStatusBadge($projectData['status'])['className'] . ' fs-12">' . getStatusBadge($projectData['status'])['label'] . '</div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
...
ob_start();
echo '<script src="' . home_url('assets/js/pages/project-overview.init.js') . '"></script>
