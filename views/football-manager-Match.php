                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-2">
                                                <div class="d-flex align-items-center justify-content-center h-100">
                                                    <h1 class="mb-0 d-flex align-items-baseline"><span>0</span><small
            ...
            <?php } else { ?>
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="text-muted">Your team does not meet the requirements to join this match. Please make the necessary adjustments to your club.</h4>
