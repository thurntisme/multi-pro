                        ...
                        <tbody class="list form-check-all">
                            ...
                            ?>
                                    <tr>
                                        ...
                                        <td class="text-center"><?= $category ? (array_values($category)[0]['icon'] . ' ' . array_values($category)[0]['title']) : '' ?></td>
                                        <td class="text-center"><?= convertAmount($item['amount']) ?></td>
                                        <td class="text-center"><?= $systemController->convertDate($item['date_expense']) ?></td>
