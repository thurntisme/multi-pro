...
<head>
  ...
  <meta charset="utf-8" />
  <title>Mercufee</title>
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <meta content="Premium Multipurpose Admin & Dashboard Template" name="description" />
  <meta content="Themesbrand" name="author" />
  <!-- App favicon -->
  <link rel="shortcut icon" href="<?= home_url('assets/images/favicon.png') ?>">
    ...
    <nav class="navbar navbar-expand-lg navbar-landing fixed-top" id="navbar">
      <div class="container">
        <a class="navbar-brand" href="<?= home_url('') ?>">
          <img src="<?= home_url("assets/images/dark-logo.png") ?>" class="card-logo card-logo-dark" alt="logo dark" height="29">
          <img src="<?= home_url("assets/images/light-logo.png") ?>" class="card-logo card-logo-light" alt="logo light" height="29">
        </a>
          ...
          <div class="col-lg-8 col-sm-10">
            <div class="text-center mt-lg-5 pt-5">
              ...
              <div class="d-flex gap-2 justify-content-center mt-4">
                <a href="<?= home_url('login') ?>" class="btn btn-primary">Get Started <i class="ri-arrow-right-line align-middle ms-1"></i></a>
