                ...
                <div class="col-lg-8 col-sm-10">
                    <div class="text-center mt-lg-5 pt-5">
                        ...
                        <div class="d-flex gap-2 justify-content-center mt-4">
                            <a href="<?= home_url('login') ?>" class="btn btn-primary">Get Started <i
                ...
                <div class="col-lg-4">
                    <div class="d-flex p-3">
                        ...
                        <div class="flex-grow-1">
                            ...
                            <p class="text-muted my-3 ff-secondary">Personalise your own website, no matter what theme
                                and what customization options.</p>
                            <div>
                                <a href="#" class="fs-13 fw-medium">Learn More <i
                                            class="ri-arrow-right-s-line align-bottom"></i></a>
                            </div>
            ...
            <div class="row align-items-center gy-4">
                ...
                <div class="col-lg-6">
                    <div class="text-muted">
                        ...
                        <p class="mb-4 ff-secondary fs-16">Collection widgets specialize in displaying many elements of
                            the same type, such as a collection of pictures from a collection of articles from a news
            ...
            <div class="row align-items-center gy-4">
                <div class="col-lg-6 order-2 order-lg-1">
                    <div class="text-muted">
                        ...
                        <div class="mt-4">
                            <a href="<?= home_url('') ?>" class="btn btn-primary">Learn More <i
                                        class="ri-arrow-right-line align-middle ms-1"></i></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        ...
                        <div class="d-flex justify-content-center align-items-center">
                            ...
                            <div>
                                <h5 class="fs-14 mb-0">Annual <span class="badge bg-success-subtle text-success">Save 20%</span>
                                </h5>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="row justify-content-center">
                                        <div class="col-10">
                                            <div class="text-white-50">
                                                <p class="fs-20 ff-secondary mb-4">" I am givng 5 stars. Theme is great
                                                    and everyone one stuff everything in theme. Future request should
                                        ...
                                        <div class="col-10">
                                            <div class="text-white-50">
                                                <p class="fs-20 ff-secondary mb-4">" Awesome support. Had few issues
                                                    while setting up because of my device, the support team helped me
                                                    fix them up in a day. Everything looks clean and good. Highly
                                                    recommended! "</p>
                                        ...
                                        <div class="col-10">
                                            <div class="text-white-50">
                                                <p class="fs-20 ff-secondary mb-4">" Amazing template, Redux store and
                                                    ...
                                                    based project. Clean Code and good documentation. Template is
                ...
                <div class="col-lg-8">
                    <div class="text-center mb-5">
                        ...
                        <p class="text-muted mb-4 ff-secondary">In an ideal world this website wouldn’t exist, a client
                            would acknowledge the importance of having web copy before the Proin vitae ipsum vel ex
