...
ob_start();
echo '<link href="' . home_url('assets/libs/sweetalert2/sweetalert2.min.css') . '" rel="stylesheet" />';
...
ob_start();
echo '<script src="' . home_url("/assets/libs/sweetalert2/sweetalert2.min.js") . '"></script>;';
