...
<div class="row">
    <div class="mb-3">
        <a href="<?= home_url('todo') ?>" class="btn btn-soft-primary btn-label waves-effect waves-light"><i
                                    ...
                                    <div class="row">
                                        <div class="col-xxl-4">
                                            <div class="row border border-dashed gx-2 p-2 mb-2">
                                                <div class="col-4">
                                                    <img src="<?= home_url('assets/images/small/img-2.jpg') ?>" alt=""
                                                        class="img-fluid rounded" />
                                                </div>
                                                <!--end col-->
                                                <div class="col-4">
                                                    <img src="<?= home_url('assets/images/small/img-3.jpg') ?>" alt=""
                                                        class="img-fluid rounded" />
                                                </div>
                                                <!--end col-->
                                                <div class="col-4">
                                                    <img src="<?= home_url('assets/images/small/img-4.jpg') ?>" alt=""
                                                        class="img-fluid rounded" />
                                                </div>
                                                <!--end col-->
                                            </div>
