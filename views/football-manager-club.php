                                    ...
                                    <?php foreach ($playerItems as $item) { ?>
                                        <div class="col-3 text-center">
                                            <button class="btn btn-outline-light btn-player-action"
                                                    data-confirm-text="<?= $item['msg'] ?>"
                                                    data-item-uuid="<?= $item['uuid'] ?>">
                                                <img src="<?= home_url('assets/images/football-manager/' . $item['image']) ?>"
                                                     class="img-responsive avatar-xs" alt=""/>
                                            </button>
                                            <div class="text-muted text-center mt-2 fw-500 fs-12"><?= formatCurrency($item['price']) ?></div>
                                        </div>
                                    <?php } ?>
                                </div>
                            </div>
                                                        ...
                                                        <tr style="background-color: <?= getBackgroundColor($player_ability) ?>"
                                                            ...
                                                            <td style="width: 10%;">
                                                                <span class="ps-2 position"
                                                                      style="border-left: solid 4px <?= getPositionColor($item['position_in_formation'] ?? $item['best_position']) ?>"> <?= $item['position_in_formation'] ?? $item['best_position'] ?></span>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td class="text-center" style="width: 42px;">
                                                                <span class="form"><?php echo getFormDirection($item['player_form']) ?></span>
                                                            </td>
                                                    ...
                                                    <li class="list-group-item hstack gap-2">
                                                        <div class="w-50 d-flex justify-content-between">
                                                            ...
                                                            <span class="fs-12"><span
                                                                        id="player-height"><?= $lineupPlayers[0]['height'] ?></span> cm</span>
                                                        </div>
                                                        |
                                                        <div class="w-50 d-flex justify-content-between">
                                                            <span class="fs-12">Weight</span>
                                                            <span class="fs-12"><span
                                                                        id="player-weight"><?= $lineupPlayers[0]['weight'] ?></span> kg</span>
                                                        </div>
                                                    </li>
                                                    <li class="list-group-item hstack gap-2">
