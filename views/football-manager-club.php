                        ...
                        <div class="row">
                            <div class="col-4 text-center">
                                <div class="profile-user position-relative d-inline-block mx-auto">
                                    <img src="<?= home_url('assets/images/users/avatar-1.jpg') ?>" class="rounded-circle avatar-md img-thumbnail user-profile-image" alt="user-profile-image">
                                </div>
                            </div>
                            <div class="col-8">
                                <h5 class="fs-16 mb-1"><?= $lineupPlayers[0]['name'] ?></h5>
                                <p class="text-muted mb-0 fs-14"><?= $lineupPlayers[0]['nationality'] ?></p>
                                <p class="text-muted mb-0 mt-2"><?= $lineupPlayers[0]['best_position'] ?> (<?= $lineupPlayers[0]['abilities']['current_ability'] ?>) | <?= implode(", ", $lineupPlayers[0]['playable_positions']) ?></p>
                            </div>
                        </div>
                                ...
                                <tbody class="list form-check-all">
                                    <?php if (count($lineupList['resources']) > 0) {
                                        foreach ($lineupList['resources'] as $item) { ?>
                                            <tr>
                                                <td class="text-center" style="width: 10%;"><?= $item['best_position'] ?></td>
                                                <td><?= $item['name'] ?></td>
