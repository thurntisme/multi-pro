                                        ...
                                        <th>
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <select class="form-select form-select-sm" data-choices
                                                    ...
                                                    data-choices-search-false id="formation" value="<?= $myTeam['formation'] ?>">
                                ...
                                <div class="card-body">
                                    <div class="table-responsive table-card">
                                        ...
                                        <div class="p-3">
                                            ...
                                            <?php } else { ?>
                                                <div class="text-muted">Find player and register they into your team</div>
                                                <a href="<?= home_url('football-manager/transfer') ?>" class="btn btn-soft-primary mt-2">Go to Market <i
                                    ...
                                    <div class="p-3">
                                        <?php if (count($subPlayers) > 0) { ?>
                                            <div class="table-responsive table-card" data-simplebar style="max-height: 442px;">
                                                <table class="table align-middle table-nowrap mb-0">
                                                    <tbody class="list form-check-all">
                                                        <?php foreach ($subPlayers as $item) { ?>
                                                            <tr>
                                                                <td class="text-center"
                                                                    style="width: 10%;"><?= $item['best_position'] ?></td>
                                                                <td><?= $item['name'] ?></td>
