                                ...
                                <table class="table align-middle table-nowrap mb-0">
                                    <thead class="table-light">
                                        <tr>
                                            ...
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/assist.png') ?>" class="img-responsive avatar-xxs" alt="assist" />
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/goal.png') ?>" class="img-responsive avatar-xxs" alt="goals" />
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/yellow-card.png') ?>" class="img-responsive avatar-xxs" alt="yellow card" />
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                            ...
                                            <th class="text-center px-1" style="width: 80px;">
                                                <img src="<?= home_url('assets/images/football-manager/stamina.png') ?>" class="img-responsive avatar-xxs" alt="stamina" />
                                            </th>
                                        </tr>
                                    </thead>
                                </table>
