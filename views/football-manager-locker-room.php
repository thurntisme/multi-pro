                                ...
                                <div class="table-responsive table-card">
                                    <table class="table align-middle table-nowrap mb-0">
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/shirt.png') ?>"
                                                     class="img-responsive avatar-xxs" alt="shirt number"/>
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/assist.png') ?>"
                                                     class="img-responsive avatar-xxs" alt="assist"/>
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/goal.png') ?>"
                                                     class="img-responsive avatar-xxs" alt="goals"/>
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/yellow-card.png') ?>"
                                                     class="img-responsive avatar-xxs" alt="yellow card"/>
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/red-card.png') ?>"
                                                     class="img-responsive avatar-xxs" alt="red card"/>
                                            </th>
                                            <th class="text-center px-1" style="width: 52px;">
                                                <img src="<?= home_url('assets/images/football-manager/contract-time.png') ?>"
                                            ...
                                            <table class="table align-middle table-nowrap mb-0" id="player-list">
                                                ...
                                                <?php foreach ($myTeam['players'] as $index => $item) { ?>
                                                    <tr class="my-club-player-row"
                                                        ...
                                                        <td class="text-center px-1"
                                                            style="width: 52px;"><?= $item['assists'] ?></td>
                                                        <td class="text-center px-1"
                                                            style="width: 52px;"><?= $item['goals_scored'] ?></td>
                                                        <td class="text-center px-1"
                                                            style="width: 52px;"><?= $item['yellow_cards'] ?></td>
                                                        <td class="text-center px-1"
                                                            style="width: 52px;"><?= $item['red_cards'] ?></td>
                                                        <td class="text-center px-1"
                                    ...
                                    <div class="row mt-3">
                                        <div class="col-12 px-1">
                                            <div class="mb-3">
                                                ...
                                                <select class="js-example-basic-multiple" name="player_roles[]"
                                                        multiple="multiple">
