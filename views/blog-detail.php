                    ...
                    <div class="row">
                                                ...
                                                <div class="d-flex mt-4">
                                                    ...
                                                    <div class="flex-grow-1 ms-3">
                                                        ...
                                                        <p class="text-muted">Please be sure to check your Spam mailbox
                                                            to
                                                            see if your email filters have identified the email from
                                                            Dell as
                                                            spam.</p>
                        ...
                        <div class="col-xl-3 col-lg-4">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <a href="<?= home_url('/app/' . $firstSlug) ?>" class="btn btn-light w-sm">Back</a>
                                    <a href="<?= home_url('/app/' . $firstSlug . '/edit?id=' . $postData['id']) ?>"
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="d-flex flex-wrap gap-2 fs-16">
                                        <?php foreach ($tags as $key => $value) { ?>
                                            <div class="badge fw-medium bg-secondary-subtle text-secondary"><?= $value ?></div>
                                        <?php } ?>
                                    </div>
                                </div>
                                <!-- end card body -->
                                            ...
                                            <div class="d-flex align-items-center">
                                                ...
                                                <div class="flex-shrink-0">
                                                    <div class="d-flex align-items-center gap-1">
                                                        <button type="button" class="btn btn-light btn-sm">Message
                                                        </button>
                                                        <div class="dropdown">
