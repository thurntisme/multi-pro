                                        ...
                                        <div class="card-body">
                                            <div class="row g-4">
                                                <div class="col-xxl-3 col-lg-5">
                                                    <img src="<?= home_url('assets/images/blog.jpg') ?>" alt=""
                                                         class="img-fluid rounded w-100 object-fit-cover">
                                                </div><!--end col-->
                                                <div class="col-xxl-9 col-lg-7">
                                                    <p class="mb-2 text-primary text-uppercase"><a
                                                                href="<?= home_url('resources?cat=' . $resource['category']) ?>"><?= $resource['category'] ?? '' ?></a>
                                                    </p>
                                                    <a href="<?= home_url('resources/' . $resource['slug']) ?>">
                                                        <h5 class="fs-15 fw-semibold"><?= $resource['title'] ?? '' ?></h5>
                                                    </a>
                                                    <div class="d-flex align-items-center gap-2 mb-3 flex-wrap">
                                                        <span class="text-muted"><i
                                                                    class="ri-calendar-event-line me-1"></i> <?= $resource['created_at'] ?? '' ?></span>
                                                    ...
                                                    <div class="d-flex align-items-center gap-2 mt-3 flex-wrap">
                                                        ...
                                                        if (count($tags) > 0) {
                                                            foreach ($tags as $tag) { ?>
                                                                <a href="<?= home_url('resources?tag=' . $tag) ?>"
