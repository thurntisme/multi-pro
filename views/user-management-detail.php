    ...
    <div class="col-xl-8 col-md-10 offset-xl-2 offset-md-1">
        ...
        <form method="POST" action="<?= $_SERVER['REQUEST_URI'] ?>" class="me-3">
            ...
            <button type="submit" class="btn btn-<?= $postData['isActive'] === 0 ? 'success' : 'danger' ?> w-sm"><i
                    class="ri-<?= $postData['isActive'] === 0 ? 'user-follow' : 'user-unfollow' ?>-line align-bottom me-1"></i> <?= $postData['isActive'] === 0 ? 'Active' : 'Inactivate' ?>
            </button>
        </form>
        <?php
        ...
        <div class="card">
            ...
            <div class="card-body text-center">
                <div class="position-relative d-inline-block">
                    <img src="<?= home_url('assets/images/users/avatar-1.jpg') ?>" alt="" class="avatar-lg rounded-circle img-thumbnail">
                    ...
                    <table class="table table-borderless mb-0">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class='badge bg-<?= $postData['isEmailVerify'] === 0 ? 'light text-dark' : 'primary' ?>'>
                    ...
                    <tbody>
                        <?php foreach ($postData['devices'] as $index => $device) { ?>
                            <tr>
                                ...
                                <td class="text-end"><?= $systemController->convertDateTime($device['last_time_login']) ?></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
