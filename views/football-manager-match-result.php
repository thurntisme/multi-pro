                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-2">
                                            <div class="d-flex align-items-center justify-content-center h-100">
                                                <h1 class="mb-0 d-flex align-items-baseline"><span><?= $match['home_score'] ?></span><small
                                                        class="fs-14 px-2">:</small><span><?= $match['away_score'] ?></span></h1>
                                            </div>
                                        </div>
                                        <div class="col-5">
                                        ...
                                        <?php foreach ([0, 1, 2] as $idx) { ?>
                                            <div class="col-4">
                                                <div class="text-center">
                                                    ...
                                                    <div class="gift-item">
                                                        <button type="button" class="btn btn-success rounded-pill w-sm btn-open-gift"
                                                            data-item-idx="<?= $idx ?>">
                                                            <span class="d-flex align-items-center justify-content-center">
                                                                <span class="spinner-border flex-shrink-0 d-none" style="width: 20px; height: 20px;" role="status">
