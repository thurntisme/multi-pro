            ...
            <div class="card">
                <form action="<?= $_SERVER['REQUEST_URI'] ?>" method="POST">
                    ...
                    <div class="card-header">
                        ...
                        <p class="text-muted text-center mb-0 mt-1">Submit a player for consideration. We will review your submission and publish the player once approved.</p>
                    </div>
                    <div class="card-body">
                        <div class="row g-4">
                            <div class="col-lg-6">
                                <div>
                                    <label for="player-name" class="form-label">Player Name <span class="text-danger">*</span></label>
                                    <input type="text" name="player_name" class="form-control" id="player-name" placeholder="Enter Player Name" required />
                                </div>
                            </div>
                            <div class="col-lg-6">
                                <div>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <label for="best_position" class="form-label">Best Position <span class="text-danger">*</span></label>
                            ...
                            <div class="col-lg-6">
                                <div>
                                    <label for="playable_positions" class="form-label">Playable Positions <span class="text-danger">*</span></label>
                                    <select class="form-control" data-choices data-choices-removeItem name="playable_positions[]" multiple required>
                    ...
                    <div class="card-footer">
                        <div class="hstack justify-content-center gap-2">
                            <a href="<?= home_url('football-manager/store') ?>" class="btn btn-ghost-dark"><i class="ri-close-line align-bottom"></i> Cancel</a>
