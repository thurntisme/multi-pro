...
?>
    ...
    <div class="card" id="tasksList">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="flex-shrink-0">
                    <div class="d-flex flex-wrap gap-2">
                        <a class="btn btn-soft-success add-btn" href="<?= home_url('app/plan/new') ?>"><i
        ...
        <div class="card-body border border-dashed border-end-0 border-start-0">
            <form method="get" action="<?= home_url('app/plan') ?>">
                <div class="row g-3">
                    ...
                    <div class="col-xxl-2 col-sm-4 d-flex">
                        ...
                        <a href="<?= home_url("app/plan") ?>" class="btn btn-danger ms-1"><i
                            ...
                            <tr>
                                <td>
                                    <div class="d-flex align-items-baseline">
                                        <a class="text-black"
                                           href="<?= home_url('app/plan/detail?id=' . $item['id']) ?>"><?= truncateString($item['title'], 50) ?></a>
                                        <ul class="list-inline tasks-list-menu mb-0 ms-3">
                                            <li class="list-inline-item m-0"><a
                                                        class="edit-item-btn btn btn-link btn-sm"
                                                        href="<?= home_url('app/plan/detail?id=' . $item['id']) ?>"><i
                                                            class="ri-eye-fill align-bottom text-muted"></i></a>
                                            </li>
                                            <li class="list-inline-item m-0"><a
                                                        class="edit-item-btn btn btn-link btn-sm"
                                                        href="<?= home_url('app/plan/edit?id=' . $item['id']) ?>"><i
                                ...
                                <td class="text-end"><?= $commonController->convertDate($item['start_date']) ?></td>
                                <td class="text-end"><?= $commonController->convertDate($item['end_date']) ?></td>
                            </tr>
                        <?php }
                    } ?>
                    </tbody>
