...
<div class="card" id="tasksList">
        ...
        <div class="d-flex align-items-center">
            ...
            <div class="flex-shrink-0">
                <div class="d-flex flex-wrap gap-2">
                    <a class="btn btn-danger add-btn" href="<?= home_url('course/new') ?>"><i
    ...
    <div class="card-body border border-dashed border-end-0 border-start-0">
        <form method="get" action="<?= home_url('course') ?>">
            <div class="row g-3">
                <div class="col-xxl-5 col-sm-12">
                    <div class="search-box">
                        <input type="text" name="s" class="form-control search bg-light border-light"
                            placeholder="Search for courses or something...">
        ...
        <div class="table-responsive table-card mb-4">
            ...
            <div class="noresult" style="display: none">
                <div class="text-center">
                    ...
                    <p class="text-muted mb-0">Weve searched more than 200k+ courses We did not find any
