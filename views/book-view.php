    ...
    <div class="col-md-10 offset-md-1">
        ...
        ?>
            <form method="POST" action="<?= $_SERVER['REQUEST_URI'] ?>">
                ...
                <button type="submit" class="btn btn-primary w-sm"><i
                        class="ri-save-3-line align-bottom me-1"></i> Save and Back
                </button>
            </form>
        <?php
        }
            ...
            <div class="card-body">
                ...
                if (!empty($postData['view_url'])) { ?>
                    ...
                    <div class="mt-3 d-flex justify-content-center align-items-center gap-5">
                        ...
                        <span>Page: <span id="currentPage"><?= $postData['view_page'] ?? '1' ?></span> / <span id="totalPages"></span></span>
                        <div class="hstack gap-1">
                            <input type="number" class="form-control px-2 text-center" style="width: 40px;" value="<?= $postData['view_page'] ?? '1' ?>"
                                id="gotoPage">
                ...
                <?php } else { ?>
                    <div class="text-center p-5">
                        ...
                        <div class="mb-3 hstack justify-content-center gap-2">
                            <a class="btn btn-primary" href="<?= home_url('app/book') ?>">Search for Another Book</a>
                            <a class="btn btn-secondary" href="<?= home_url('app/book/edit?id=' . $post_id) ?>">Contact Support</a>
                        </div>
                        <div class="mt-4">
                            <p class="small text-muted">You can also browse our <a href="catalog.html">catalog</a> to find similar books.</p>
                        </div>
                    </div>
                <?php } ?>
            </div>
...
<script type="text/javascript">
    const url = '<?= home_url("assets/pdf/example.pdf") ?>';
