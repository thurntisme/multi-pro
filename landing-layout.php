...
<head>
    ...
    <!--Swiper slider css-->
    <link href="<?= home_url('assets/libs/swiper/swiper-bundle.min.css') ?>" rel="stylesheet" type="text/css"/>
    <!-- Layout config Js -->
...
<script src="<?= home_url('assets/js/pages/plugins/lord-icon-2.1.0.js') ?>"></script>
    ...
    (function () {
        ...
        if (toastList || dataChoices || dataProvider) {
            const scripts = [
                ...
                "<?= home_url('assets/libs/choices.js/public/assets/scripts/choices.min.js') ?>",
                "<?= home_url('assets/libs/flatpickr.min.js') ?>"
            ];
...
<!--Swiper slider js-->
<script src="<?= home_url('assets/libs/swiper/swiper-bundle.min.js') ?>"></script>

<!-- landing init -->
<script src="<?= home_url('assets/js/pages/landing.init.js') ?>"></script>
</body>
